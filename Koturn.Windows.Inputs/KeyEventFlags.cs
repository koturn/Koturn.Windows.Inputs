...
namespace Koturn.Windows.Inputs
{
    ...
    /// If <see cref="Unicode"/> is specified, <see cref="InputUtil.SafeNativeMethods.SendInput(int, ref Input, int)"/> or <see cref="InputUtil.SafeNativeMethods.SendInput(int, Input[], int)"/>
